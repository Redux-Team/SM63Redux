...
func _begin_drag_point(index: int) -> void:
	...
	_drag_start_points = _get_points().duplicate()
...
func _end_drag_point() -> void:
	...
	var old_points: PackedVector2Array = _drag_start_points
	var new_points: PackedVector2Array = _get_points().duplicate()
...
func _insert_point_on_edge(edge_index: int, pos: Vector2) -> void:
	...
	var old_points: PackedVector2Array = _get_points().duplicate()
